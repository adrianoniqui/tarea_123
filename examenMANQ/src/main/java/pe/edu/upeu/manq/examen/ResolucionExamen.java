package pe.edu.upeu.manq.examen;
...
public  void examen02MANQ() {
    ...
    System.out.println("total a pagar del impuesto es de : " + ip);
}
public  void examen03MANQ() {
...
public  void examen05MANQ() {

        int x;


        do {
            System.out.print("Deme  el sistema decimal:");
            x = leer.nextInt();
        } while (x < 0);
        System.out.println();
        ...
        michi(x);
        System.out.println();
    } public static void michi(int n) {
        if (n < 2) {
            System.out.print(n);
            return;
        } else {
